...
public static String[][] persones = new String[0][5];
public static String[][] personesAux;
public static int posPersona;
...
public static boolean trobat;
    ...
    public static void llistarElements() {
        if (persones.length == 0) {
    ...
    public static void llistarElement() {
        if (persones.length == 0) {
            System.out.println("Encara no hi ha persones...");
        } else {
    ...
    public static void modificarElement() {
        if (persones.length == 0) {
            ...
            if (trobat) {
                ...
                persones[idPersona][1] = nom;
                persones[idPersona][2] = cognom;
                persones[idPersona][3] = edat;
                persones[idPersona][4] = telefon;
